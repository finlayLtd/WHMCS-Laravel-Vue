        ...
        <div class="row">
            ...
            <div class="card-item data-region-card p-4">
              ...
              <div class="">
                <ul class="server-features">
                  <li>
                    <img src="assets/img/cpu.png" alt="" />1x Intel E5-2697v3
                    (14C, 28T)
                  </li>
                  <li><img src="assets/img/ram.png" alt="" />6 GB RAM</li>
                  <li>
                    <img src="assets/img/hard-disk.png" alt="" />40 GB SSD
                  </li>
                  <li>
                    <img src="assets/img/speedometer.png" alt="" />Unlimited
                    traffic
                  </li>
                  <li>
                    <img src="assets/img/cable.png" alt="" />1 Dedicated IPv4
                  </li>
                </ul>
              </div>
              <div class="more-details-wrapper mt-3">
                <div class="more-details-content">
                  <p>
                    ...
                    quia debitis iste nemo assumenda omnis? Quo, dignissimos,
                    ducimus!
                  </p>
                </div>
                <a
          ...
          <div class="col-md-3">
            <div class="card-item data-region-card p-4">
              <div class="server-price mb-4">
                <span class="price"
                  >€100<span class="month">/ month</span></span
                >
              </div>
          ...
          <div class="col-md-3">
            <div class="card-item data-region-card p-4">
              <div class="server-price mb-4">
                <span class="price"
                  >€120<span class="month">/ month</span></span
                >
              </div>
          ...
          <div class="col-md-3">
            <div class="card-item data-region-card p-4">
              <div class="server-price mb-4">
                <span class="price"
                  >€150<span class="month">/ month</span></span
                >
              </div>
          ...
          <div class="configure-server-form">
            <form>
              ...
              <div class="mb-3 text-end">
                <button type="submit" class="btn btn-dark hover-dark-light">
                  Create Server
                </button>
              </div>
            </form>
