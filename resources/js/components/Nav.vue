  ...
  <header class="border-bottom sticky-top" v-show="isAuthLayout == false">
    <nav class="navbar navbar-expand-lg navbar-light">
      <div class="container d-flex flex-wrap align-items-center justify-content-between py-3">
        <router-link class="logo-wrapper d-flex align-items-center col-md-2 text-dark text-decoration-none order-lg-1"
          to="/dashboard">
        ...
        <div class="col-md-4 d-flex align-items-center justify-content-end order-lg-3">
          <div class="profile-area position-relative d-mobile-none">
            <div class="options-toggle dropdown-toggle lang-div" style="margin-right: 24px; cursor: pointer"
              ...
              <span class="ip2location-flag-16 flag-round flag-ru" style="margin: 10px 0px -3px 5px" id="language-flag"
                v-if="locale == 'ru'">
              </span>
              <span class="ip2location-flag-16 flag-round flag-cn" style="margin: 10px 0px -3px 5px" id="language-flag"
                v-else-if="locales[locale] == '中文'">
              </span>
              <span class="ip2location-flag-16 flag-round flag-us" style="margin: 10px 0px -3px 5px" id="language-flag"
                v-else>
              </span>
          ...
          <div class="form-check form-switch d-inline">
            <input class="form-check-input" type="checkbox" id="modeSwitch" @click="toggleSortingItems" />
          </div>

          <!--Nav Action Buttons-->

          <router-link class="btn-balance btn-login d-lg-block hover-light-dark" to="/balance">
          ...
          <div class="profile-area position-relative">
            <img class="profile-img options-toggle dropdown-toggle" src="/assets/img/profile.png" alt=""
              data-bs-toggle="dropdown" />
            <div class="options-toggle-dropdown dropdown-menu dropdown-menu-end">
              <ul class="">
                <li class="dropdown-profile-item">
                  <img style="width: 28px; height: 28px" src="/assets/img/profile.png" alt="" />{{ user.name }}
                </li>

                <li style="border-bottom: unset !important">
                  <router-link to="/settings">
                    <img style="filter: brightness(2.5)" src="/assets/img/settings.svg" alt="" />{{ $t('settings_nav') }}
                  </router-link>
                </li>
                <li style="border-bottom: unset !important">
                ...
                <li>
                  <router-link to="/support-ticket">
                    <img style="filter: brightness(2.5)" src="/assets/img/messages.svg" alt="" />{{
                      $t('support_tickets_nav') }}</router-link>
                </li>
                <li>
                  <a href="javascript:void(0)" @click="logout">
                    <img src="/assets/img/signout.svg" style="margin-right: 15px !important; margin-left: 3px" alt="" />{{
                      $t('logout_nav') }}</a>
                </li>
              </ul>
            </div>
          ...
          <ul class="navbar-nav justify-content-center mb-md-0">
            ...
            <li class="nav-item mobile-only" style="display: none;">
              <div class="profile-area position-relative">
                <div class="options-toggle dropdown-toggle lang-div" style="margin-right: 24px; cursor: pointer"
                  data-bs-toggle="dropdown">
                  <span class="ip2location-flag-16 flag-round flag-ru" style="margin: 10px 0px -3px 12px"
                    id="language-flag" v-if="locale == 'ru'">
                  </span>
                  <span class="ip2location-flag-16 flag-round flag-cn" style="margin: 10px 0px -3px 12px"
                    id="language-flag" v-else-if="locales[locale] == '中文'">
                  </span>
                  <span class="ip2location-flag-16 flag-round flag-us" style="margin: 10px 0px -3px 12px"
