          ...
          <div class="row justify-content-between align-items-center">
            <div class="col-md-12">
              <div class="w-100 mb-2 mb-lg-5">
                ...
                <div class="topTicketBar">
                  <div class="sort-servers order-2 order-md-1">
                    <div id="toggleButton" class="sort-item-active btn-chevron chevron-dark topSortBox"
                  ...
                  <ul class="nav nav-pills mb-3 mb-md-0 order-1 order-md-2 mb-lg-0 topFilterBox" id="pills-tab"
                    role="tablist">
              ...
              <div class="w-100 server-list-pagination">
                <Pagination :currentPage="params.page" :totalPages="totalFilterPages[ticketStatus]"
