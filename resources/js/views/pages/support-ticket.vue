					...
					<div class="col-md-9 d-flex pe-0 flex-wrap">
						...
						<div class="sort-servers order-2 order-md-1" >
							...
							<div class="sorting-items" v-if="sortBy">
								<ul>
									<li class="touch-item" >Opened-latest</li>
									<li class="touch-item">Opened-oldest</li>
									<li class="touch-item">Last-Reply-latest</li>
									<li class="touch-item">Last-Reply-oldest</li>
								</ul>
							</div>
						</div>
